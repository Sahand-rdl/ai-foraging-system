...
explicit feedback from prior outputs (e.g., missing content, ambiguity, etc.). Each refinement
addresses a specific deficiency observed in the previous iteration.
